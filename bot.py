...
TOKEN = os.getenv("BOT_TOKEN")  # ناخد التوكن من متغير بيئة
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("أهلاً وسهلاً بك في Body AI 🤖\nأتمنى لك تجربة سعيدة 🌟", reply_markup=reply_markup)
...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    parse_mode="Markdown"
)        await update.message.reply_text("⬅️ اضغط رجوع للقائمة", reply_markup=ReplyKeyboardMarkup([["رجوع للقائمة"]], resize_keyboard=True))
